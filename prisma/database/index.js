...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\usuario022\\Desktop\\GitHub\\Todo-API\\prisma\\database",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "329497ee30654af6b8a4a8197f5ec9bfa81f28070364f0b85e08fa423b3d308b",
  "copyEngine": true
}
...
path.join(process.cwd(), "prisma/database/libquery_engine-debian-openssl-1.1.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-rhel-openssl-1.0.x.so.node");
path.join(process.cwd(), "prisma/database/libquery_engine-rhel-openssl-1.0.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-rhel-openssl-3.0.x.so.node");
path.join(process.cwd(), "prisma/database/libquery_engine-rhel-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
